  ...
  if (me && me.role !== "admin") {
    return (
      <div className="flex flex-col h-full items-center justify-center gap-3 text-center px-6">
        ...
        <p className="text-xs text-muted-foreground">Contact your administrator to manage team members.</p>
      </div>
    );
  }
        ...
        <div className="flex h-14 items-center gap-2 border-b border-border px-5 shrink-0 bg-sidebar">
          {view !== "list" && (
            <button
              ...
              className="text-muted-foreground hover:text-foreground mr-1 text-sm"
            >
              ←
            </button>
          )}
