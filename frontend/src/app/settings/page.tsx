...
function SettingsContent() {
  ...
  const initialTab = (searchParams.get("tab") as Tab) || "signature";
  ...
  useEffect(() => {
    const tab = (searchParams.get("tab") as Tab) || "signature";
    setActiveTab(tab);
        ...
        <nav className={cn(
          ...
          {NAV_ITEMS.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className={cn(
                "flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors whitespace-nowrap shrink-0 sm:w-full",
                activeTab === id
          ...
          {activeTab === "signature" && (
            <div className="p-5 space-y-4 max-w-2xl">
              ...
              <div className="flex justify-end gap-2 pt-1">
                <Button variant="outline" size="sm" onClick={() => router.push("/")}>Cancel</Button>
                ...
                <div className="rounded-xl border border-border p-4 space-y-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <Badge
                      ...
                      className={cn(
                        "shrink-0",
                        tfaEnabled ? "border-green-400/40 text-green-600" : "text-muted-foreground",
                      )}
                    >
